...
/**
 * Main API for exporting ASG structures to Graphviz DOT format.
...
class GraphvizExporter(
    ...
    /**
     * Exports an ASG document to DOT format string.
     * @param document The ASG document to export
     * @return Valid DOT format string ready for Graphviz rendering
     */
    fun export(document: AsgDocument): String {
    ...
    /**
     * Exports an ASG document to a DOT format file.
     ...
     */
    fun exportToFile(document: AsgDocument, filePath: String): FileWriteResult {
