...
/**
 * Apple implementation of FileSystemAccess using POSIX APIs.
 */
...
actual class DefaultFileSystemAccess actual constructor() : FileSystemAccess {
    ...
    actual override fun isDirectory(path: String): Boolean {
        memScoped {
            ...
            val mode = statBuf.st_mode.convert<UInt>()
            return (mode and S_IFMT.convert<UInt>()) == S_IFDIR.convert<UInt>()
        }
    }
