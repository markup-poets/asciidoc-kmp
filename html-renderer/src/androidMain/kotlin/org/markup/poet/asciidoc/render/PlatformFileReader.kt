...
/**
 * Android implementation of FileReader using java.io.File and java.nio.file APIs.
 * 
 * Android uses the same JVM file I/O APIs as the JVM platform, so this implementation
 * is identical to the JVM version.
 * 
 * This implementation:
...
actual class PlatformFileReader : FileReader {
    ...
    /**
     * Reads file content as a string using Android/JVM file I/O APIs.
     * 
