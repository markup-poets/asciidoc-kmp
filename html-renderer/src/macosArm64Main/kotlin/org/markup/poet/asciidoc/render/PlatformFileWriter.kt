...
/**
 * macOS implementation of FileWriter using Foundation APIs.
 * 
 * Uses NSFileManager and NSString for file operations.
 * Creates parent directories if they don't exist.
 * Supports both absolute and relative file paths.
 * 
 * Note: This implementation is identical to the iOS version as both
 * platforms use the same Foundation framework.
 */
