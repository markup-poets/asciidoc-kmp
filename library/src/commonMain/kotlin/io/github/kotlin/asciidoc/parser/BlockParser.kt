...
interface BlockParser {
     ...
     */
    fun parseList(lines: List<String>, startLineNumber: Int, listType: io.github.kotlin.asciidoc.ast.ListType): AsciiDocList
...
class DefaultBlockParser(
    ...
    override fun parseList(lines: List<String>, startLineNumber: Int, listType: io.github.kotlin.asciidoc.ast.ListType): AsciiDocList {
    ...
    private fun parseListItem(line: String, lineNumber: Int, listType: io.github.kotlin.asciidoc.ast.ListType): ListItem {
    ...
    private fun extractListItemContent(line: String, listType: io.github.kotlin.asciidoc.ast.ListType): Pair<String, String> {
        val trimmed = line.trim()
