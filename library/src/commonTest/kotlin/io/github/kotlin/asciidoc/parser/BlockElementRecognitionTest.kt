...
class BlockElementRecognitionTest {
    ...
    private fun generateListTestData(): TestListData {
        val listType = when (Random.nextInt(3)) {
            0 -> io.github.kotlin.asciidoc.ast.ListType.UNORDERED
            1 -> io.github.kotlin.asciidoc.ast.ListType.ORDERED
            else -> io.github.kotlin.asciidoc.ast.ListType.DEFINITION
        }
...
data class TestListData(val lines: List<String>, val lineNumber: Int, val listType: io.github.kotlin.asciidoc.ast.ListType) : TestBlockElement()
