...
class NodeTypeAssignmentCorrectnessTest {
    ...
    private fun generateListTestCase(): ListTestCase {
        val listType = ListType.values().random()
    ...
    private fun generateListLines(listType: ListType): List<String> {
...
data class ListTestCase(val input: List<String>, val lineNumber: Int, val listType: ListType) : NodeTypeTestCase()
...
data class ListMarkerTestData(val lines: List<String>, val lineNumber: Int, val expectedType: ListType)
